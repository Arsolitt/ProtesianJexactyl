    ...
    return (
        <GreyRowBox css={tw`mb-2`}>
            ...
            <div css={tw`ml-4`}>
                <p css={tw`font-medium text-center`}>
                    ...
                    {subuser.twoFactorEnabled ? (
                        <Icon.Lock css={tw`text-main-500`} />
                    ) : (
                        <Icon.Unlock css={tw`text-negative-500`} />
                    )}
                    {/*&nbsp;*/}
                    <p css={tw`text-2xs text-neutral-500 uppercase hidden md:block`}>2FA</p>
                </p>
            </div>
            <div css={tw`ml-4 hidden md:block`}>
                ...
                <p css={tw`text-2xs text-neutral-500 uppercase`}>Разрешений</p>
            </div>
            {subuser.uuid !== uuid && (
                <>
